...
function! s:Tlist_Window_Init()
    ...
    nnoremap <buffer> <silent> <CR>
                \ :call <SID>Tlist_Window_Jump_To_Tag('useopen')<CR>:TlistToggle<CR>
    ...
    nnoremap <buffer> <silent> <C-G> :call <SID>Tlist_Window_Show_Info()<CR>
    ...
    "inoremap <buffer> <silent> <C-G>         <C-o>:call
