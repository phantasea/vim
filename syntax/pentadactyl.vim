...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ nno[remap] noh[lfind] noimg nojs no[remap] norm[al] nunm[ap] okimg okjs
    \ olistk[eys] olk om[ap] ono[remap] o[pen] ounm[ap] pa[geinfo] pagest[yle]
    \ pas pin[tab] pref[erences] prefs pw[d] qma[rk] qmarks q[uit] quita[ll]
    \ qa[ll] redr[aw] reg[isters] reh[ash] re[load] reloada[ll] res[tart]
    ...
    \ u[ndo] undoa[ll] unl[et] unm[ap] unpin[tab] verb[ose] ve[rsion]
    \ vie[wsource] vlistk[eys] vlk vm[ap] vno[remap] vunm[ap] winc[lose]
    \ wc[lose] wind[ow] winon[ly] wino[pen] wo[pen] wqa[ll] wq xa[ll] y[ank]
    \ zo[om]
    \ contained
